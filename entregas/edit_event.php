...
$query_event = "UPDATE events SET title=:title, color=:color, start=:start, end=:end, sala=:sala, nome_usuario=:nome_usuario WHERE id=:id";
...
$update_event->bindParam(':nome_usuario', $dados['nome_usuario']);
